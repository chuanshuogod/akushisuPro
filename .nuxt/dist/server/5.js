...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=184c40e6&
...
// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=184c40e6&
...
const request_request = external_axios_default.a.create({
...
/* harmony default export */ var loginvue_type_script_lang_js_ = ({
  ...
  methods: {
    async onSubmit() {
      // const {data} = await request.post('/api/users/login',{user:this.user})
      try {
        // 提交表单请求登录
        const {
          data
